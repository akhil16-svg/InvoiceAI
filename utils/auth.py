...
class AuthSystem:
    ...
    def _init_postgres(self):
        ...
        cursor.execute("ALTER TABLE users ADD COLUMN IF NOT EXISTS verification_code TEXT")
        cursor.execute("ALTER TABLE users ADD COLUMN IF NOT EXISTS verification_code_expires TIMESTAMP")
